...
- создан playbook;
- использована роль ClickHouse из Ansible Galaxy;
- разработана собственная роль Vector;
- разработана собственная роль LightHouse;
- роли опубликованы в отдельных GitHub-репозиториях;
- установка выполняется через requirements.yml;
